...
/********** FUNCTIONS **********/
    ...
    /*  Este método lista la información de los paquetes con esta 4 - Finalizado y que sean de faseOP 2 - Comite
        ...
        try {
            ...
            if (hasPermission.error) {
                ...
                if (response.error !== null) {
                    ...
                    data = response.data;
                    /*  Se asigna el valor de la fecha de envío, fecha de creación y fecha de resolucion. */
...
/********** RENDER **********/
    ...
    return (
        <div>            
            ...
            {openAlertModal && <AlertElement typeAlert={elementAlertModal.titleAlert} openModal={openAlertModal} title={elementAlertModal.titleAlert} handCloseModal={handCloseModal} />}
