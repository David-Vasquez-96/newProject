...
export default function ReporteDeComites() {
    ...
    const DescargarReporte = async () =>{
        ...
        try {
            ...
            if (response.error != null){
                ...
                functions.downloadPDFFromStringBase64(response.data.base64,"Reporte de Comites.pdf");
        } catch (error) {
            Alert.error(error);
        }        
    ...
    const [buttonList,setButtonList]= React.useState({
        "reporteComites":{"label":"Descargar Reporte","icon": <GetApp />,"callback":DescargarReporte, isCancel: false, "loading":false,"size":"medium","color":"#fff", "background":"linear-gradient(130deg, rgb(6, 107, 189) 30%, rgb(30, 136, 229) 90%) repeat scroll 0% 0% ",}, 
    });    
        ...
        <Container maxWidth="lg">
            ...
            <Grid container>
                <div className={classes.root}>
                    <Grid container>
                        <React.Fragment>
                            <Title title="Reporte de Comites" icon="/assets/ReporteComites.png" />
