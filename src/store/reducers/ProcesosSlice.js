...
const initialState = { 
    processList: [
        {id: 1, backgroundColor: {r:'243', g:'101', b:'14', a:'100'}, image: 'assets/subir.svg', title: 'Instructivos 1'},
        {id: 2, backgroundColor: {r:'253', g:'189', b:'0', a:'100'}, image: 'assets/subir.svg', title: 'Políticas 1'},
        {id: 3, backgroundColor: {r:'146', g:'31', b:'143', a:'100'}, image: 'assets/subir.svg', title: 'Procedimientos 1'},
        {id: 4, backgroundColor: {r:'238', g:'75', b:'154', a:'100'}, image: 'assets/subir.svg', title: 'Manuales 1'},
        {id: 5, backgroundColor: {r:'54', g:'182', b:'111', a:'100'}, image: 'assets/subir.svg', title: 'Matrices 1'},
    ...
    newProcess: {id:0, backgroundColor: '', image: '', title: ''},
};
...
export const procesosSlice = createSlice({
    ...
    reducers: {
        ...
        saveNewProcessData: (state, action) => {
            if (action?.payload?.id || action?.payload?.id==='') state.newProcess.id = action?.payload?.id;
