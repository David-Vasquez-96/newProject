...
const ComponenteCardListadoPorCategoria=(props)=> {
    const classes = useStyles(props);
    return (
        <Card className={classes.contendorCard} onClick={(props.FuctionOpenFileViewer) ? (()=>props.FuctionOpenFileViewer(props.data)) : (()=>{})}>
            ...
            <Typography className={classes.cardSubTitle}>Última actualización: {functions.dateFormatGeneral(props?.data?.publicacion)}</Typography>
        </Card>
    )
}
export default (ComponenteCardListadoPorCategoria);