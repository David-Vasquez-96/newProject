    ...
    const classes = useStyles(),
        ...
        [elementsAffiliate, setElementsAffiliate] = useState({
            ...
            secondName: {
                ...
                pattern: "^([\\w_Ññ][\\w_ Ññ]*[\\w_Ññ]){0,25}$", errorMessages: ["Sin tíldes. Sin espacios al inicio al final"], isError: false,
                elementType: "input", key: 15, keys: [15, 16],
            },
            afiliateDate: {
                idelement: "afiliateDate", value: null,  label: "Fecha de Afiliación *", validators: ["required"],
